...
<div class="row padding-top padding-bottom">			
		<div class="col s12 m6 offset-m1">
         ...
         <p>Conception et réalisation d'un site vitrine sur-mesure, identité visuelle</p>
              <a href="http://http://www.le-fab-dd.fr//" target="_blank"><i class="material-icons">&#xE89E;</i></a>
		</div>	
				<div class="col s12 m4 offset-m1">
...
<section class="panelWorks three">
	<div class="row padding-top padding-bottom">
		...
		<div class="col s12 m6 offset-m1">
			<h3 class="deep-purple-text text-darken-4">Cookies</h3>
			<div class="underlign"></div>
              <p>Conception et réalisation d'un site vitrine sur-mesure, identité visuelle</p>
...
<section class="panelWorks five">
	<div class="row padding-top padding-bottom">	
		...
		<div class="col s12 m6 offset-m1">
			<h3 class="deep-purple-text text-darken-4">Take that stick !</h3>
...
<section class="panelWorks seven">	
	<div class="row padding-top padding-bottom">	
		...
		<div class="col s12 m6 offset-m1">
			<h3 class="deep-purple-text text-darken-4">Timoun</h3>
